...
for(var p in participants){
	...
	//Clear the database
	try{
		var pQuery = 'SELECT ogc_fid, ST_AsGeoJSON(wkb_geometry) AS geom '+select_query+' FROM re_blocks WHERE '+where_query+' ';
	...
	fs.writeFileSync('./export_map/'+participants[p]+'.geojson', JSON.stringify(geojson));
}
